...
def serializedATN():
    return [
        4,1,11,33,2,0,7,0,2,1,7,1,1,0,1,0,1,0,4,0,8,8,0,11,0,12,0,9,1,1,
        ...
        6,1,-1,0,12,20,5,9,0,0,13,20,5,8,0,0,14,20,5,10,0,0,15,16,5,6,0,
...
class exprParser ( Parser ):
    ...
    class OctalContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterOctal" ):
                listener.enterOctal(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitOctal" ):
                listener.exitOctal(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitOctal" ):
                return visitor.visitOctal(self)
            else:
                return visitor.visitChildren(self)
    ...
    class HexaContext(ExprContext):
        ...
        def HEX(self):
            return self.getToken(exprParser.HEX, 0)
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [9]:
                localctx = exprParser.OctalContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
